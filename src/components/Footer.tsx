...
// import heartLogo from "/imgs/BsHeartPulse.jpeg";  
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-24">
          <div>
            <div className="flex items-center mb-4 gap-2">
              <img src={'/imgs/heart-logo.png'} alt="Cure Logo" className="mr-2" />
            ...
            <div className="flex gap-3">
              <SocialIcon Icon={RiFacebookFill} link="#" />
              <SocialIcon Icon={RiTwitterFill} link="#" />
              <SocialIcon Icon={IoLogoWhatsapp} link="#" />
              <SocialIcon Icon={IoLogoYoutube} link="#" />
              <SocialIcon Icon={IoLogoLinkedin} link="#" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-white text-xl">Home</a></li>
                <li><a href="#" className="text-white text-xl">Doctors</a></li>
                <li><a href="#" className="text-white text-xl">FAQs</a></li>
                <li><a href="#" className="text-white text-xl">Contact Us</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 font-sans">
                <li><a href="#" className="text-white text-xl">Help Center</a></li>
                <li><a href="#" className="text-white text-xl">How it works</a></li>
                <li><a href="#" className="text-white text-xl">Privacy Policy</a></li>
                <li><a href="#" className="text-white text-xl">Terms & Conditions</a></li>
              </ul>
            </div>

            {/* Contact */}
            <div>
              <h3 className="text-white text-2xl font-serif mb-4">Contact Info</h3>
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200 text-sm">532 Merense Street,<br/>Malad Mill, 1205 New York</p>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <div className="flex items-center gap-3">
        ...
        <div className="md:hidden bg-[#05162c] text-white pt-8 pb-4 px-4 text-center">
          <div className="flex mb-6 justify-center items-center">
            <img src={'/imgs/BsHeartPulse.jpeg'} alt="Cure Logo" className="w-10 h-10 mr-2" />
