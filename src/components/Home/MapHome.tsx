...
export default function FindCareMap() {
  ...
  const doctors = [
    {
      id: 1,
      position: [44.9878, -93.255] as [number, number],
      img: "/images/img Map/Location Image (1).png",
      name: "Dr. Smith",
    },
    {
      id: 2,
      position: [44.9728, -93.275] as [number, number],
      img: "/images/img Map/Location Image (2).png",
      name: "Dr. Johnson",
    },
    {
      id: 3,
      position: [44.9678, -93.245] as [number, number],
      img: "/images/img Map/Location Image.png",
      name: "Dr. Williams",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-none text-center lg:text-left">
            ...
            <p className="text-[15px] md:text-sm lg:text-base text-[#6D7379] leading-relaxed font-sans max-w-lg mx-auto lg:mx-0">
              Allow location access or choose your city to
              <br />
              instantly discover trusted doctors and clinics
              <br />
            ...
            >
              ...
              <Marker position={centerPosition} icon={redIcon}>
                <Popup>
                  <div className="text-center font-sans">
                    <strong>Walker Art Center</strong>
                  </div>
                </Popup>
              </Marker>
              ...
              {doctors.map((doctor) => (
                <Marker
                  ...
                  icon={createDoctorIcon(doctor.img)}
                >
                  <Popup>
