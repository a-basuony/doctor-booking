        ...
        <div className="bg-gray-200/30 rounded-3xl p-6 shadow-xl shadow-slate-100">
          ...
          <div className="flex justify-between mb-4">
            ...
            <button
              ...
              className="bg-white w-11 h-11 rounded-full flex items-center justify-center hover:text-blue-500 transition cursor-pointer"
              aria-label="Start chat"
            >
              <img src={chatImage} alt="Chat" className="w-5 h-5 cursor-pointer" />
            </button>
          </div>
