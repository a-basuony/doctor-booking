...
import type { IDoctor } from "../../types"; // افتراض إن الـ IDoctor موجود في المسار ده
...
const MapCard: React.FC<MapCardProps> = ({ doctor, isSelected, onClick }) => {
   return (
      <Box
         onClick={onClick}
         className={`flex items-start gap-3 p-3 mb-2 rounded-xl cursor-pointer transition-all duration-200 ${isSelected
