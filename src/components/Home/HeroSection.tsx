      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-full text-sm font-normal border border-blue-100">
            ...
            <span className=" text-slate-700 font-sans font-normal">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-base md:text-2xl text-gray-600 leading-relaxed mb-8 font-sans font-normal">
            Easily find top-rated specialists near you and book <br />
            appointments in just a few clicks. Whether you
            <br /> need an in-person visit consultation, we're here to
            <br /> connect you with the right care—fast, simple, and <br />
            secure.
          </p>
          ...
          <div className="flex items-center p-2 justify-center gap-3 mb-8 border-transparent border-gray-300 rounded-full  bg-gray-300/20">
            ...
            <span className="text-xl font-georgia font-normal text-gray-500">
              10k+ happy patients
            </span>
          </div>
        ...
        <div className="hidden lg:block">
          <div className="absolute left-52 top-56 -translate-y-1/2 flex flex-col items-center gap-2">
            ...
            <span className="text-[14px] p-2 font-serif font-normal text-gray-800  border-transparent bg-slate-100  rounded-full ">
              Doctors near you
            </span>
          </div>
