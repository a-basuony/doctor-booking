    ...
    <section className="py-5 mt-10 mb-10">
      <div className="max-w-4xl mx-auto text-center px-4">
        <div className="inline-block mb-4">
          <span className="bg-blue-50 text-blue-600 text-xs font-medium px-3 py-1 rounded-full">Frequently Asked Questions</span>
        </div>

        <h2 className="text-3xl md:text-4xl font-semibold text-slate-900 mb-8">Got Questions ? We\'ve got Answers!</h2>
