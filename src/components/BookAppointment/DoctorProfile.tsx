    ...
    <div className="sticky top-8 w-full">
      <FadeIn delay={100}>
        <div className="bg-gray-200/30 rounded-3xl p-6 shadow-xl shadow-slate-100">
          ...
          <div
            className="flex flex-col items-center mb-8 cursor-pointer hover:bg-gray-50/50 p-2 rounded-xl transition-colors"
          ...
          >
            ...
            <h1 className="text-xl font-serif text-slate-800 mb-1 hover:text-blue-600 transition-colors">
