...
export const DoctorCard: React.FC<DoctorCardProps> = ({ doctor, index }) => {
  ...
  const safeDoctor = {
    ...
    name: doctor.name || "Dr. Unavailable",
    specialty: doctor.specialty || "General Practitioner",
    hospital: doctor.hospital || "Medical Center",
    rating: doctor.rating || 4.0,
    timeStart: doctor.timeStart || "9:00am",
    timeEnd: doctor.timeEnd || "5:00pm",
    price: doctor.price || 200,
    image: doctor.image || "https://picsum.photos/id/100/200/200",
    ...
    >
      <div className="flex gap-4 mb-4">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-slate-900">{safeDoctor.name}</h3>

          <p className="text-sm text-slate-500">
            {safeDoctor.specialty} | {safeDoctor.hospital}
          </p>
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <div className="flex items-center gap-1 text-slate-400">
              ...
              <span className="text-xs">
                {safeDoctor.timeStart} - {safeDoctor.timeEnd}
              </span>
            </div>
          </div>
        </div>
      ...
      <Link
        to={`/SearchDoctors/${safeDoctor.id}`}
